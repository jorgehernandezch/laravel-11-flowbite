<nav class="fixed left-0 right-0 top-0 z-50 px-5 py-2.5 bg-gray-800">
    <div class="flex flex-wrap items-center justify-between">
        <div class="flex items-center justify-start">
            ...
            {{-- Logotipo --}}
            <a href="{{ route('app.index') }}" class="flex items-center justify-between mr-4">
                <img
        ...
        <div class="flex items-center lg:order-2">
            ...
            >
                ...
                <a class="text-md block bg-gray-50 py-2 text-center font-medium text-gray-900 hover:bg-gray-100" href="#">
            ...
            >
                ...
                <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
                    <li>
                        <a class="block px-4 py-2 text-sm hover:bg-gray-100" href="#">
                            My profile
                        </a>
                    </li>
                    <li>
